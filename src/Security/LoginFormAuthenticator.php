...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator
{
     ...
     */
    public function __construct(FormFactoryInterface $formFactory, EntityManagerInterface $em, FlashBagInterface $flashBag, LoggerInterface $logger, RouterInterface $router, TranslatorInterface $translator, UserPasswordEncoderInterface $passwordEncoder)
    {
